...
from .views import article_list, article_detail_by_slug, article_create, article_delete_by_slug
...
urlpatterns = [
    ...
    path('delete/<slug:slug>/', article_delete_by_slug, name='article-delete-by-slug'), # Zmieniono na slug
]